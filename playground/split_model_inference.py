...
from playground.split_model import *
from pytorch.pytorch_utils import move_data_to_device
from playground.base_config import *
...
def audio_tagging(args):
    ...
    mel_spec_power = mel_spec_power.T
    mel_spec_power = mel_spec_power[None, None, :]
    mel_spec_power = move_data_to_device(mel_spec_power, device)

    # Forward
    with torch.no_grad():
        model.eval()
        batch_output_dict = model(mel_spec_power, None)
